"use client";
import { authenticate } from "../actions/loginhandler";
          ...
          <form action={dispatch}>
            <div className="mb-4">
              ...
              <input
                ...
                id="email"
                name="email"
                className="bg-zinc-800 text-white shadow-sm rounded-md w-full px-3 py-2 border border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                placeholder="Email"
                required
              />
            </div>
