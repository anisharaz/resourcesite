    ...
    <>
      <div className="pb-4 ml-8 mr-8">
        ...
        <div className="flex justify-center items-center">
          ...
          >
            <div className="mt-6 text-gray-900 border border-gray-300 focus:outline-none hover:bg-blue-600 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 bg-blue-800 dark:text-white dark:border-gray-600   ">
              Get Started
            </div>
          </Link>
        </div>
